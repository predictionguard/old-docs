---
title: ChatPG Chatbot
---

# ChatPG

A chatbot that responds using state-of-the-art text generation. This bot uses a Prediction Guard text generation endpoint along with [Gradio](https://gradio.app/). Here some sample output:
