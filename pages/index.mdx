...
of SOTA models on the backend, and ensure the best possible output.

To create your first proxy endpoint for a sentiment analysis task:
...
listing your proxies, as further discussed [here](./reference/proxy).

Once available, you can start generating inferences/ predictions:
