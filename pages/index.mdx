...
We host the latest LLMs for you, so you can focus on your prompts. To access the hosted LLMs (and our guarded interfaces to closed LLMs like OpenAI), sign up for a Prediction Guard account [here](https://beta.predictionguard.com/auth/signup). If you signed up via email/password you will need to verify your email. Check your email for the verification link.

After verifying your email, you will need to [pick a subscription level](https://predictionguard.com/#pricing) 
that makes sense for you. However, you can get started for free with our Basic plan.

<Callout type="info" emoji="ℹ️">
  If you need a higher rate limit and are scaling up, contact us at **contact@predictionguard.com**. 
</Callout>

## 2. Grab an access token

Once you are signed up (and signed in), head over to the [access tokens page](https://predictionguard.com/app). Click
...
## 5. Explore other output types, models, and guides
