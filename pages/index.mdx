...
Sign up for a Prediction Guard account [here](https://predictionguard.com/auth/signup). If you signed up via email/password
you will need to verify your email. Check your email for the verification link.

After verifying your email, you can [sign up for a subscription](https://predictionguard.com/#pricing) that makes sense for you. Our pricing is simple. Pay for a 
...
Once you are all signed up (and signed in), head over to the [access tokens page](https://predictionguard.com/app). Click
