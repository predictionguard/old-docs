...
10. **Create Response Message Block:** Set up a block in ManyChat to relay the response to the user.
...
3. **Send Data to Lambda Function:** Configure the block to send "Full Contact Data" to your Lambda function.
...
- Append the Prediction Guard response to the bot messages array (Bot_Text)
