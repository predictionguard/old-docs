...
Here is a video tutorial for more detailed guidance:
  ...
  <iframe
    src="https://youtu.be/_DxsmP0Lb2I?si=MiRIqesDEsCLjVUz"
    width="100%"
    height="500px"
    title="SWR-States"
  />
...
```
![External Request Body](./manychatimages/manychat-makeexternalrequest2.png)
...
![No context finished flow](./manychatimages/manychat-nocontext2.png)
